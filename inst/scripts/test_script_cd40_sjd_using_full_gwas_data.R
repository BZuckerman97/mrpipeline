sjd <- data.table::fread(
  "/Users/benzuckerman/Library/Mobile Documents/com~apple~CloudDocs/Research/mr_work/data/sjogrens_6098_34928.txt"
)

cd40 <- format_pqtl_ukbppp(
  ukbppp = "data/CD40_data_50.csv",
