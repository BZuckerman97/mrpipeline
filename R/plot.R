...
#' @param ... Ignored.
#'
#' @return A list of ggplot objects, one per exposure-outcome pair, as
#'   returned by TwoSampleMR's plotting functions -- for a single analysis,
#'   take `[[1]]`. Returns `NULL` invisibly if the result status is not
